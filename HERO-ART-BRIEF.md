...
transparent PNGs is the single most useful thing — it lets us scale them crisply on
...
| 2 | **Logo lockup** | **PNG, transparent background** | ~1600 px wide | Slime-dripping SEER FRIGHTS wordmark + glowing eyeball emblem. Isolated, no scene behind it. |
| 3 | **Book stack** | **PNG, transparent background** | ~1400 px wide | The two-book 3D stack (Swamp front, scarecrow behind). Isolated, no scene behind it. |
